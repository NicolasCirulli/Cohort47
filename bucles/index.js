...
const listaContainer = document.getElementById( 'lista-home' )
...
const mentoresConNombre = mentores.filter( mentor => mentor.nombre )
pintarLista( mentoresConNombre, listaContainer )